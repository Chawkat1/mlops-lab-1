Lab 1 Prepared by chawkat choumane 231736
...
After running dvc init, DVC creates the .dvc folder and the .dvc ignore file. The .dvc folder contains DVC configuration and local cache information, while .dvcignore tells DVC which files to ignore. We should push .dvc and .dvcignore to Git, but not the DVC cache or large data files.
